...
<html>
    ...
    <body>
        ...
        <nav class="w3-sidebar w3-bar-block w3-card-2 w3-animate-left w3-center" style="display:none" id="mySidebar">
            ...
            <a href="ciclos_consumoOP.jsp" class="w3-bar-item w3-button">Ciclos de consumo</a>
            <a href="SubsidyTypeOP.jsp" class="w3-bar-item w3-button">Tipo de subsidio</a>
        </nav>
        ...
        <header class="w3-container w3-teal w3-padding" id="myHeader">
            ...
            <div class="w3-center">
                <div class="w3-padding-25" style="text-align: right;">
                 <!--   <button class="w3-btn w3-theme-dark w3-hover-teal" onclick="document.getElementById('register').style.display = 'block'">Registrar personal</button>-->
                ...
                <h1 id ="sv" class="w3-xxxlarge w3-animate-bottom">SERVICIOS PUBLICOS</h1>
            </div>
        </header>
        ...
        <div class="w3-row-padding w3-center w3-margin-top">
            <div class="w3-third">
                <div class="w3-card-2 w3-container" style="min-height:460px">
                    ...
                    <br><br><br><br><br>
                    <a href="HogaresOP.jsp"><button class="w3-btn w3-theme">Entrar</button></a>
                </div>
            </div>
            ...
            <div class="w3-third">
                <div class="w3-card-2 w3-container" style="min-height:460px">
                    ...
                    <br><br><br><br><br>
                    <a href="ConsumosOP.jsp"><button class="w3-btn w3-theme">Entrar</button></a>
                </div>
            </div>
            ...
            <div class="w3-third">
                <div class="w3-card-2 w3-container" style="min-height:460px">
                    ...
                    <br><br><br><br><br>
                    <a href="SubsidyOP.jsp"><button class="w3-btn w3-theme">Entrar</button></a>
                </div>
            </div>
            ...
            <div class="w3-third">
               ...
               <div class="w3-third">
                <div class="w3-card-2 w3-container" style="min-height:460px">
                    ...
                    <br><br><br><br><br>
                    <a href="personasOP.jsp"><button class="w3-btn w3-theme">Entrar</button></a>
                </div>
            </div>
